...
> Sandamini, H. (2026). *SriLanka_Leptospirosis_Dataset: Weekly leptospirosis case counts by district in Sri Lanka, 2007–2026 (extracted from Epidemiology Unit WER reports)* [Dataset]. GitHub. https://github.com/hsandamini/SriLanka_Leptospirosis_Dataset

*(Update the year range and add your thesis/paper title once finalized.)*
...
Add a `LICENSE` file with the MIT text to the repo root for the code license to be enforceable on GitHub.
