...
If you use this dataset in academic work, please cite this repository. *(Add your name, thesis/paper title, and institution here once finalized.)*

## License

*(Add a license — e.g. MIT for the code. Note that the underlying WER data belongs to the Epidemiology Unit, Ministry of Health, Sri Lanka, and should be attributed accordingly regardless of the code license.)*
